...
//	echo '<li class="pid">PID:', $message['member']['pid'], '</li>';
	...
	echo '
									...
									<a style="color: #687bff" target="_blank" href="', $scripturl.'?action=send&message_id='.$message['id'], '&topic_id='.$context['current_topic'], '&title='.$message['subject'], '">+Merit</a><a style="color: #884d00;margin-left: 3px" target="_blank" href="', $scripturl.'?action=send&sa=flm&message_id='.$message['id'], '&topic_id='.$context['current_topic'], '&title='.$message['subject'], '">+RCP</a>
