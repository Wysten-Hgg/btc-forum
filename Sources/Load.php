...
function loadTheme($id_theme = 0, $initialize = true)
{
	...
	$jQueryUrls = array ('cdn' => 'https://lib.baomitu.com/jquery/'. JQUERY_VERSION . '/jquery.min.js', 'jquery_cdn' => 'https://code.jquery.com/jquery-'. JQUERY_VERSION . '.min.js', 'microsoft_cdn' => 'https://ajax.aspnetcdn.com/ajax/jQuery/jquery-'. JQUERY_VERSION . '.min.js');
	...
	// Fall back to the forum default
		...
		loadJavaScriptFile('https://lib.baomitu.com/jquery/' . JQUERY_VERSION . '/jquery.min.js', array('external' => true, 'seed' => false), 'smf_jquery');
